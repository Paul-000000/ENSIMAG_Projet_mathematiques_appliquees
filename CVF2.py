...
def segmentation_chan_vese(image: MaskedArray, sigma=1.2, mu=0.15, lambda1=1, lambda2=1, 
                           max_num_iter=300, tol=1e-4) -> ndarray:
...
from manipulation_images_tif import tests_segmentation_chanvese

if __name__ == "__main__":
    tests_segmentation_chanvese()
