...
if __name__ == "__main__":
    ...
    def tests_segmentation_Z(fonction_segmentation : Callable[[MaskedArray, int, int], ndarray], annee : int = 2021, mean_monthly : bool = True, resolution : int = 300) -> None:   
    ...
    def graphe_scores_Z(fonction_segmentation: Callable[[MaskedArray, int, int], ndarray],
