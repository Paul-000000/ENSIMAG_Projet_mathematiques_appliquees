    ...
    for zone in range(1, 9):
        ...
        for mois in range(1, 13):
            ...
            try:
                ...
                c = test_correlation(img_ref, img_seg)
...
if __name__ == "__main__":
    ...
    def segmentation_test(image : MaskedArray) -> ndarray:
        ...
        # exemple : seuil bête pour avoir une segmentation
        return (image_no_nan > np.nanmean(image_no_nan)).astype(np.uint8)

    # Calcul des scores moyens pour cette méthode sur 2021
    scores = moyen_score(segmentation_test, annee=2021, mean_monthly=False)
